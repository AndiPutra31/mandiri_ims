        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <form role="form" action="<?php echo base_url() ?>pegawai/addPegawai_act" method="post" enctype="multipart/form-data">
                <div class="card">
                   <!-- <div class="row gutters-sm">
                        ...
                        <div class="col-6 col-sm-4">
                              <img src="<?php echo base_url(); ?>assets/img/mandiri_logo.png" alt="logo mandiri" width="200px" >
                        </div>
                      </div> -->
